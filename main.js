...
function createModal() {
  ...
  popUpWindow.innerHTML = `<div class="head">
    <h4 class="project-title roboto white pop-up-title">${ProjectObjects[0].projectName}</h4>
    <a href="" id="close">
  ...
  <img src="${ProjectObjects[0].projectImg}" alt=" an image for my project" class="pop-up-img">
  ...
  <ul class="lists pop-up-list">
    <li class="inter white li-border pop-up-textlist">${ProjectObjects[0].projectTechnologies[0]}</li>
    <li class="inter white li-border pop-up-textlist">${ProjectObjects[0].projectTechnologies[1]}</li>
    <li class="inter white li-border pop-up-textlist">${ProjectObjects[0].projectTechnologies[2]}</li>
    <li class="inter white pop-up-textlist">${ProjectObjects[0].projectTechnologies[3]}</li>
  </ul>
  <div class="pop-up-btns">
    <a href="${ProjectObjects[0].projectLive}" class="btn btn-primary pop-up-btn white roboto">See Live<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="${ProjectObjects[0].projectSource}" class="btn roboto btn-primary pop-up-btn white github">See Source <svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
